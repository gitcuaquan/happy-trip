...
const timeTmp = ref({ hours: new Date().getHours(), minutes: new Date().getMinutes() })
const dateTmp = ref(new Date(new Date().getTime() + 24 * 60 * 60 * 1000).toISOString())
...
watch(()=>[dateTmp.value,timeTmp.value], (value) => {
    ...
    //@ts-ignore
    objPreview.date_go = new Date(obj.year, obj.month, obj.day, obj.hours, obj.minutes);
})
  ...
  <div class="row g-2 mt-3">
    ...
    <div class="col-lg-6">
      <div class="d-flex gap-2">
        <VueDatePicker @internal-model-change="handleInternal" required :enable-time-picker="false"
          :format-locale="vi" placeholder=" Chọn ngày, giờ khởi hành" selectText="Xác nhận" cancelText="Hủy"
          :min-date="new Date()" v-model="dateTmp">
        </VueDatePicker>
