...
<template>
  <div class="row g-2 mt-3">
    <div class="col-12">
      <div class="alert alert-danger" role="alert">
        Hệ thống đang nâng cấp nhằm giúp quý khách hàng đặt chuyến tiện lợi hơn, do đó Happy Trip tạm thời tắt chức năng
        đặt xe trực tuyến. Quý khách vui lòng liên hệ trực tiếp qua số điện thoại 0972970000 để đặt xe. Xin cảm ơn!
      </div>
    </div>
    <div class="col-lg-6">
      <div>
    ...
    <div class="col-lg-6">
      <div class="d-flex gap-2">
        <VueDatePicker @internal-model-change="handleInternal" required :enable-time-picker="false" :format-locale="vi"
          placeholder=" Chọn ngày, giờ khởi hành" selectText="Xác nhận" cancelText="Hủy" :min-date="new Date()"
          v-model="dateTmp">
        </VueDatePicker>
        <VueDatePicker style="width: 200px" time-picker v-model="timeTmp" :min-time="{ hours: minH, minutes: minM }"
          selectText="Xác nhận" cancelText="Hủy" />
      </div>
    </div>
    <div class="col-lg-6">
  ...
  <div class="text-center my-2">
    <button @click="createOrder" disabled="true" class="btn btn-primary text-light">
